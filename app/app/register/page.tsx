    ...
    <div className="min-h-screen bg-brand-grey flex items-center justify-center px-6 py-10">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl shadow-brand-dark/5 p-8 border border-brand-light/10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold text-brand-dark mb-2">Register Akun</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                minLength={3}
                className="w-full bg-brand-grey/50 border border-brand-light/20 rounded-2xl py-3 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-brand-medium/20 focus:border-brand-medium transition-all text-brand-dark placeholder:text-brand-light/50"
          ...
          {/* INFO BOX (Specific to Register but styled to match theme) */}
          <div className="p-4 bg-brand-grey/50 border border-brand-light/10 rounded-2xl text-sm flex gap-3 items-center text-brand-light">
             <div className="w-2 h-2 rounded-full bg-brand-medium flex-shrink-0 animate-pulse" />
             <p>Role akun akan otomatis diset sebagai <span className="font-bold text-brand-dark">User</span></p>
          </div>
